      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6 sm:mb-8">
        <div className="bg-white p-5 rounded-2xl border border-slate-200/60 shadow-sm flex flex-col justify-between h-32 relative overflow-hidden group">
          ...
          <div className="space-y-1.5 mt-2 z-10">
            <h3 className="text-2xl font-black text-slate-850 tracking-tight leading-none">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200/60 shadow-sm flex flex-col justify-between h-32 relative overflow-hidden group">
          ...
          <div className="space-y-1.5 mt-2 z-10">
            <h3 className="text-2xl font-black text-slate-850 tracking-tight leading-none">{customer.totalOrders}</h3>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200/60 shadow-sm flex flex-col justify-between h-32 relative overflow-hidden group">
          ...
          <div className="space-y-1.5 mt-2 z-10">
            <h3 className="text-2xl font-black text-slate-850 tracking-tight leading-none">{redeemedCount}</h3>
