  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-50">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="lg:hidden sticky top-0 z-30 flex items-center h-16 px-4 bg-[#0A0F1F] border-b border-white/10 shadow-lg flex-shrink-0">
          <button
          ...
          <span className="ml-3 text-white font-semibold text-lg tracking-tight">TechSentinals ERP</span>
        </header>
