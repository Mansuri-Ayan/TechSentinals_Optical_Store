...
import { X, Beaker, Plus, Save, Loader2 } from 'lucide-react';
...
const AddEditLabModal = ({ isOpen, onClose, onSubmit: onSubmitProp, item = null, isSaving = false }) => {
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm flex flex-col border border-slate-100 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100 bg-slate-50 flex-shrink-0">
          <div className="flex items-center gap-3">
            <div className={`p-2 rounded-xl flex-shrink-0 ${isEdit ? 'bg-amber-500/10 border border-amber-500/20 text-amber-650' : 'bg-emerald-500/10 border border-emerald-500/20 text-emerald-600'}`}>
              <Beaker className="w-5 h-5" />
            </div>
            <div>
              <h2 className="text-base font-bold text-slate-900">{isEdit ? 'Edit Lab Partner' : 'Add New Lab Partner'}</h2>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <div className="p-5 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  placeholder="e.g. Precision Lens Lab..."
              ...
              <div>
                ...
                <input
                  ...
                  className={inputCls(!!errors.contact_number, isSaving)}
                />
              ...
              <div>
                ...
                <input
                  ...
                  type="email"
                  placeholder="e.g. contact@precisionlab.com"
                  className={inputCls(!!errors.email, isSaving)}
                />
          ...
          <div className="flex items-center gap-3 px-5 py-4 border-t border-slate-100 bg-slate-50/50">
            ...
            <button type="submit" disabled={isSaving}
              ...
              {isSaving ? 'Saving...' : isEdit ? 'Update Lab' : 'Save Lab'}
            </button>
          </div>
        </form>
      </div>
...
export default AddEditLabModal;
