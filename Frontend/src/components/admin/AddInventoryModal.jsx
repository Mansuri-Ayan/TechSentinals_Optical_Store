...
const SUBCATEGORY_MAP = {
  ...
  other:  ['Contact Lens', 'Lens Solution', 'Eye Drops', 'Accessories', 'Cleaning Kit', 'Cases'],
};
...
const AddInventoryModal = ({ isOpen, onClose, onSubmit: onSubmitProp }) => {
  ...
  const subcategoryOptions = SUBCATEGORY_MAP[watchedCategory] || [];
  ...
  const onSubmit = (data) => {
    onSubmitProp?.({ ...data, image: imagePreview });
    reset();
    setImagePreview(null);
    onClose();
  };
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[95vh] flex flex-col border border-slate-100">
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="overflow-y-auto flex-1 hide-scrollbar">
          <div className="px-5 sm:px-7 py-5 sm:py-6 space-y-7">
            ...
            <section>
              ...
              <div className="flex items-center gap-4 mb-5 p-3 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <label className="cursor-pointer inline-flex items-center gap-2 px-3 py-1.5 bg-white border border-slate-200 rounded-lg text-xs font-semibold text-slate-700 hover:bg-slate-50 transition-colors">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-4">
                <div className="sm:col-span-2">
                  ...
                  })} type="text" placeholder="e.g. Ray-Ban Aviator Classic" className={inputCls(!!errors.product_name)} />
                ...
                <div>
                  ...
                  })} type="text" placeholder="e.g. RB-3025-001" className={inputCls(!!errors.sku)} />
                  <FieldError message={errors.sku?.message} />
                </div>

                <div>
                  <label className="block text-sm font-semibold text-slate-700 mb-1.5">Category <span className="text-red-500">*</span></label>
                  <select {...register('category', { required: 'Category is required' })} className={inputCls(!!errors.category)}>
                ...
                <div>
                  ...
                  <select {...register('subcategory', { required: 'Subcategory is required' })} className={inputCls(!!errors.subcategory)}>
                ...
                <div>
                  ...
                  <input {...register('brand', { required: 'Brand is required' })} type="text" placeholder="e.g. Ray-Ban" className={inputCls(!!errors.brand)} />
                ...
                <div>
                  ...
                  <input {...register('supplier', { required: 'Supplier is required' })} type="text" placeholder="e.g. Vision Supply Co." className={inputCls(!!errors.supplier)} />
                  <FieldError message={errors.supplier?.message} />
                </div>

                <div className="sm:col-span-2">
                  <label className="block text-sm font-semibold text-slate-700 mb-1.5">Description</label>
                  <textarea {...register('description')} rows={2} placeholder="Optional product description..." className={`${inputCls(false)} resize-none`} />
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-4">
                <div>
                  ...
                  })} type="number" min="0" placeholder="0" className={inputCls(!!errors.quantity)} />
                ...
                <div>
                  ...
                  })} type="number" min="1" placeholder="e.g. 10" className={inputCls(!!errors.reorder_level)} />
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-4">
                <div>
                  ...
                  })} type="number" min="0" step="0.01" placeholder="0.00" className={inputCls(!!errors.cost_price)} />
                ...
                <div>
                  ...
                  <input {...register('selling_price', {
                    ...
                    min: { value: 0, message: 'Price cannot be negative' },
                  })} type="number" min="0" step="0.01" placeholder="0.00" className={inputCls(!!errors.selling_price)} />
            ...
            <section>
              ...
              <div>
                ...
                <input {...register('store', { required: 'Store name is required' })} type="text" placeholder="e.g. Main Branch" className={inputCls(!!errors.store)} />
          ...
          <div className="flex flex-col-reverse sm:flex-row justify-end gap-2 sm:gap-3 px-5 sm:px-7 py-4 border-t border-slate-100 bg-slate-50/50 flex-shrink-0 rounded-b-2xl">
            ...
            <button type="submit"
              className="w-full sm:w-auto px-6 py-2.5 bg-slate-900 text-white hover:bg-slate-700 rounded-xl font-semibold transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5 text-sm">
              Add Item
            </button>
          </div>
        </form>
