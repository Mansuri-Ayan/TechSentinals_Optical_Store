...
const Brands = () => {
  ...
  const handleViewBrandItems = (brandId) => {
    navigate(`/shopkeeper/inventory?brand_id=${brandId}`);
  };
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="text-xs text-slate-550 font-medium mt-0.5 truncate">Added {new Date(brand.created_at).toLocaleDateString()}</div>
                    </div>
                  </div>
